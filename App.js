...
function App() {
    ...
    async function sendAndReceiveMovie(movie) {
        ...
        await fetch("https://github.com/AnastasiaTolmacheva/web2023susu303/blob/react/movies.json", {
            method: 'POST',
    ...
    return (
        <div>
            ...
            <div className="header">
                <b><font size = "5">Фильмотека</font></b>
                <div className="authorBlock"><b>Толмачева А.В., КЭ-303</b></div>
            </div>
